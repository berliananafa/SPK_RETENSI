<!-- Form Edit Konversi Nilai -->
<div class="row">
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-header">
                <strong class="card-title">Edit Konversi Nilai</strong>
            </div>
            <div class="card-body">
                ...
                <?= form_open('admin/konversi/update/' . $konversi->id_konversi) ?>
                        ...
                        <select class="form-control" id="id_cs" name="id_cs" required>
                            ...
                            <?php if (!empty($customer_service)): ?>
                                <?php foreach ($customer_service as $cs): ?>
                                    <option value="<?= $cs->id_cs ?>" <?= set_select('id_cs', $cs->id_cs, ($cs->id_cs == $konversi->id_cs)) ?>>
                            ...
                            <?php if (!empty($sub_kriteria)): ?>
                                <?php foreach ($sub_kriteria as $sub): ?>
                                    <option value="<?= $sub->id_sub_kriteria ?>" 
                                            ...
                                            <?= set_select('id_sub_kriteria', $sub->id_sub_kriteria, ($sub->id_sub_kriteria == $konversi->id_sub_kriteria)) ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="nilai_asli" name="nilai_asli" 
                               value="<?= set_value('nilai_asli', $konversi->nilai_asli) ?>" step="0.01" 
    ...
    <div class="col-md-4">
        ...
        <div class="card shadow-sm border-left-info">
            <div class="card-body">
                <h6 class="mb-3">
                    <i class="fe fe-database text-info"></i> Data Saat Ini
                </h6>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <span class="badge badge-light">
                                <?= number_format($konversi->batas_bawah ?? 0, 2) ?> - <?= number_format($konversi->batas_atas ?? 0, 2) ?>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-muted">Nilai Konversi:</td>
                        <td class="text-right">
                            <span class="badge badge-success">
                                <?= number_format($konversi->nilai_konversi ?? 0, 2) ?>
                            </span>
                        </td>
                    </tr>
                </table>
        ...
        <!-- Target Info Card -->
        <div class="card shadow-sm border-left-primary mt-3" id="targetCard" style="display:none;">
            <div class="card-body">
        ...
        <div class="card shadow-sm border-left-success mt-3" id="previewCard" style="display:none;">
            <div class="card-body">
                <h6 class="mb-3">
                    <i class="fe fe-check-circle text-success"></i> Hasil Konversi Baru
                </h6>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <div class="small text-muted">
                            Jika Anda mengubah nilai asli, sistem akan <strong>otomatis mencari ulang</strong> range yang sesuai dan nilai konversi akan <strong>dihitung ulang</strong>.
                        </div>
                    </div>
                </div>
            </div>
