    ...
    <div class="col-md-8 offset-md-2">
        <div class="card shadow">
            <div class="card-header">
                <strong class="card-title">Form Edit Leader</strong>
            </div>
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/leader/update/' . $leader->id_user) ?>" method="POST">
                    <div class="form-group">
                        <label for="nik">NIK <span class="text-danger">*</span></label>
                        <input type="text" class="form-control <?= form_error('nik') ? 'is-invalid' : '' ?>" 
                               id="nik" name="nik" value="<?= set_value('nik', $leader->nik) ?>" 
                    ...
                    <div class="form-group">
                        <label for="nama_pengguna">Nama Leader <span class="text-danger">*</span></label>
                        <input type="text" class="form-control <?= form_error('nama_pengguna') ? 'is-invalid' : '' ?>" 
                               id="nama_pengguna" name="nama_pengguna" value="<?= set_value('nama_pengguna', $leader->nama_pengguna) ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control <?= form_error('email') ? 'is-invalid' : '' ?>" 
                               id="email" name="email" value="<?= set_value('email', $leader->email) ?>" 
                    ...
                    <div class="form-group text-right mb-0">
                        <a href="<?= base_url('admin/leader') ?>" class="btn btn-secondary">
