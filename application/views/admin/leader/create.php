    ...
    <div class="col-md-8 offset-md-2">
        <div class="card shadow">
            <div class="card-header">
                <strong class="card-title">Form Tambah Leader</strong>
            </div>
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/leader/store') ?>" method="POST">
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Info:</strong> Password default adalah "<strong>password</strong>". Leader dapat mengubahnya setelah login pertama kali.
                    </div>
