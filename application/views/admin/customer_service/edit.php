    ...
    <div class="col-md-8 offset-md-2">
        <div class="card shadow">
            <div class="card-header">
                <strong class="card-title">Edit Customer Service</strong>
            </div>
            <div class="card-body">
                <?= form_open('admin/customer-service/update/' . $cs->id_cs, ['id' => 'formCS']) ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="nama_cs" 
                               name="nama_cs" 
                               value="<?= set_value('nama_cs', $cs->nama_cs) ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_tim" 
                            ...
                            <?php foreach ($teams as $team): ?>
                                <option value="<?= $team->id_tim ?>" 
                                    <?= set_select('id_tim', $team->id_tim, ($team->id_tim == $cs->id_tim)) ?>>
                        ...
                        <select name="id_produk" 
                            ...
                            <?php foreach ($products as $product): ?>
                                <option value="<?= $product->id_produk ?>" 
                                    <?= set_select('id_produk', $product->id_produk, ($product->id_produk == $cs->id_produk)) ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kanal" 
                            ...
                            <?php foreach ($channels as $channel): ?>
                                <option value="<?= $channel->id_kanal ?>" 
                                    <?= set_select('id_kanal', $channel->id_kanal, ($channel->id_kanal == $cs->id_kanal)) ?>>
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card border-left-warning shadow">
            <div class="card-body">
                ...
                <ul class="mb-0 small">
                    <li>Perubahan data CS dapat mempengaruhi data penilaian yang sudah ada</li>
                    <li>Pastikan NIK tetap valid jika diubah</li>
                    <li>Perubahan Tim akan mempengaruhi struktur organisasi</li>
                </ul>
            </div>
        </div>
    </div>
