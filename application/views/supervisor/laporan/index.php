	...
	<div class="col-12">
		<div class="card shadow">
			<div class="card-header bg-gradient-info text-white">
				...
				<small class="text-white-50">Analisis performa CS di tim Anda</small>
			</div>
			<div class="card-body">
				<!-- Filter Section -->
				<div class="row mb-4">
				...
				<div class="text-center">
					<hr>
					<a href="<?= base_url('supervisor/laporan/export?periode=' . $filter_periode) ?>" class="btn btn-primary">
...
<script>
	$(document).ready(function() {
		...
		$('#btnFilter').on('click', function() {
			...
			var url = '<?= base_url('supervisor/laporan') ?>?';
			var params = [];
