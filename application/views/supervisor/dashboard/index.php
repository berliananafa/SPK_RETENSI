            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <span class="h3 font-weight-bold mb-0 text-primary"><?= number_format($total_leader ?? 0) ?></span>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow">
            ...
            <div class="list-group list-group-flush">
                <a href="<?= base_url('supervisor/leader') ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                    <i class="fe fe-users text-primary mr-3 fe-20"></i>
                    <div>
                        <strong>Daftar Leader</strong>
                        <div class="small text-muted">Lihat leader Anda</div>
                    </div>
                </a>
                <a href="<?= base_url('supervisor/tim') ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                ...
                <a href="<?= base_url('supervisor/customer-service') ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                ...
                <a href="<?= base_url('supervisor/ranking') ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                ...
                <a href="<?= base_url('supervisor/laporan') ?>" class="list-group-item list-group-item-action d-flex align-items-center">
            ...
            <div class="card-body p-0">
                <?php if (!empty($top_cs)): ?>
                    ...
                    <div class="card-footer bg-light text-center">
                        <a href="<?= base_url('supervisor/ranking?periode=' . ($current_periode ?? '')) ?>"
