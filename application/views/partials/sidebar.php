    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <div class="mb-4 w-100 d-flex">
            <a class="mx-auto mt-2 text-center navbar-brand flex-fill" href="<?= base_url() ?>">
                <img src="<?= base_url('assets/img/ethos_logo.png') ?>" alt="Ethos Logo" style="max-width: 120px; height: auto;" class="mb-2">
        ...
        <?php if ($user_level === 'admin'): ?>
            ...
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item dropdown <?= (strpos($current_url, 'admin/junior-manager') !== false || strpos($current_url, 'admin/supervisor') !== false || strpos($current_url, 'admin/leader') !== false) ? 'active' : '' ?>">
                    <a href="#organisasi" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'admin/junior-manager') !== false || strpos($current_url, 'admin/supervisor') !== false || strpos($current_url, 'admin/leader') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-briefcase"></i>
                        <span class="ml-3 item-text">Struktur Organisasi</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'admin/junior-manager') !== false || strpos($current_url, 'admin/supervisor') !== false || strpos($current_url, 'admin/leader') !== false) ? 'show' : '' ?>" id="organisasi">
                        <li class="nav-item <?= (strpos($current_url, 'admin/junior-manager') !== false) ? 'active' : '' ?>">
                ...
                <li class="nav-item dropdown <?= (strpos($current_url, 'admin/tim') !== false || strpos($current_url, 'admin/customer-service') !== false) ? 'active' : '' ?>">
                    <a href="#team" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'admin/tim') !== false || strpos($current_url, 'admin/customer-service') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-users"></i>
                        <span class="ml-3 item-text">Tim & CS</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'admin/tim') !== false || strpos($current_url, 'admin/customer-service') !== false) ? 'show' : '' ?>" id="team">
                        ...
                        <li class="nav-item <?= (strpos($current_url, 'admin/customer-service') !== false) ? 'active' : '' ?>">
            ...
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item dropdown <?= (strpos($current_url, 'admin/kriteria') !== false || strpos($current_url, 'admin/sub-kriteria') !== false) ? 'active' : '' ?>">
                    <a href="#kriteria" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'admin/kriteria') !== false || strpos($current_url, 'admin/sub-kriteria') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-sliders"></i>
                        <span class="ml-3 item-text">Kriteria</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'admin/kriteria') !== false || strpos($current_url, 'admin/sub-kriteria') !== false) ? 'show' : '' ?>" id="kriteria">
            ...
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item dropdown <?= (strpos($current_url, 'admin/nilai') !== false) ? 'active' : '' ?>">
                    <a href="#nilai" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'admin/nilai') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-edit"></i>
                        <span class="ml-3 item-text">Input Nilai CS</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'admin/nilai') !== false) ? 'show' : '' ?>" id="nilai">
                        ...
                        <li class="nav-item <?= (strpos($current_url, 'admin/nilai') !== false && strpos($current_url, 'admin/nilai/input') === false) ? 'active' : '' ?>">
            ...
            <p class="mt-4 mb-1 text-muted nav-heading"><span>Laporan & Ranking</span></p>
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item dropdown <?= (strpos($current_url, 'admin/ranking') !== false) ? 'active' : '' ?>">
                    <a href="#ranking" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'admin/ranking') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-award"></i>
                        <span class="ml-3 item-text">Hasil Ranking</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'admin/ranking') !== false) ? 'show' : '' ?>" id="ranking">
                        <li class="nav-item <?= (strpos($current_url, 'admin/ranking') !== false && strpos($current_url, 'admin/ranking/export') === false) ? 'active' : '' ?>">
                            <a class="pl-3 nav-link" href="<?= base_url('admin/ranking') ?>">
                                <span class="ml-1 item-text">Lihat Ranking</span>
                            </a>
                        </li>
                        <li class="nav-item <?= (strpos($current_url, 'admin/ranking/export') !== false) ? 'active' : '' ?>">
                            <a class="pl-3 nav-link" href="<?= base_url('admin/ranking/export') ?>">
                                <span class="ml-1 item-text">Export Data</span>
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <?php elseif ($user_level === 'junior_manager'): ?>
            <!-- Menu Junior Manager -->
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item w-100 <?= (strpos($current_url, 'junior-manager/dashboard') !== false) ? 'active' : '' ?>">
            ...
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item w-100 <?= (strpos($current_url, 'junior-manager/supervisor') !== false) ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url('junior-manager/supervisor') ?>">
                        <i class="fe fe-user-check"></i>
                        <span class="ml-3 item-text">Supervisor</span>
                    </a>
                </li>
                <li class="nav-item w-100 <?= (strpos($current_url, 'junior-manager/team-overview') !== false) ? 'active' : '' ?>">
            ...
            <p class="mt-4 mb-1 text-muted nav-heading"><span>Penilaian</span></p>
            <ul class="navbar-nav flex-fill w-100">
                <li class="nav-item dropdown <?= (strpos($current_url, 'junior-manager/nilai') !== false) ? 'active' : '' ?>">
                    <a href="#nilai-jm" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'junior-manager/nilai') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-edit"></i>
                        <span class="ml-3 item-text">Input Nilai</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'junior-manager/nilai') !== false) ? 'show' : '' ?>" id="nilai-jm">
                        <li class="nav-item <?= (strpos($current_url, 'junior-manager/nilai/input') !== false) ? 'active' : '' ?>">
                            <a class="pl-3 nav-link" href="<?= base_url('junior-manager/nilai/input') ?>">
                                <span class="ml-1 item-text">Input Penilaian</span>
                            </a>
                        </li>
                        <li class="nav-item <?= (strpos($current_url, 'junior-manager/nilai/history') !== false) ? 'active' : '' ?>">
                ...
                <li class="nav-item w-100 <?= (strpos($current_url, 'junior-manager/ranking') !== false) ? 'active' : '' ?>">
        ...
        <?php elseif ($user_level === 'supervisor'): ?>
            ...
            <ul class="navbar-nav flex-fill w-100">
                ...
                <li class="nav-item dropdown <?= (strpos($current_url, 'supervisor/team') !== false || strpos($current_url, 'supervisor/customer-service') !== false) ? 'active' : '' ?>">
                    <a href="#team-spv" data-toggle="collapse" aria-expanded="<?= (strpos($current_url, 'supervisor/team') !== false || strpos($current_url, 'supervisor/customer-service') !== false) ? 'true' : 'false' ?>" class="dropdown-toggle nav-link">
                        <i class="fe fe-users"></i>
                        <span class="ml-3 item-text">Tim & CS</span>
                    </a>
                    <ul class="pl-4 collapse list-unstyled w-100 <?= (strpos($current_url, 'supervisor/team') !== false || strpos($current_url, 'supervisor/customer-service') !== false) ? 'show' : '' ?>" id="team-spv">
                        <li class="nav-item <?= (strpos($current_url, 'supervisor/team') !== false) ? 'active' : '' ?>">
                            <a class="pl-3 nav-link" href="<?= base_url('supervisor/team') ?>">
                                <span class="ml-1 item-text">Daftar Tim</span>
                            </a>
                        </li>
                        <li class="nav-item <?= (strpos($current_url, 'supervisor/customer-service') !== false) ? 'active' : '' ?>">
